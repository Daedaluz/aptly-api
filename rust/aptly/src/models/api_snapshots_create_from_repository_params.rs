...
pub struct ApiSnapshotsCreateFromRepositoryParams {
...
impl ApiSnapshotsCreateFromRepositoryParams {
    pub fn new(name: String) -> ApiSnapshotsCreateFromRepositoryParams {
