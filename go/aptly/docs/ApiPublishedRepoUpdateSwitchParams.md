...
`func (o *ApiPublishedRepoUpdateSwitchParams) GetArchitectures() []string`

GetArchitectures returns the Architectures field if non-nil, zero value otherwise.

### GetArchitecturesOk

`func (o *ApiPublishedRepoUpdateSwitchParams) GetArchitecturesOk() (*[]string, bool)`
...
`func (o *ApiPublishedRepoUpdateSwitchParams) SetArchitectures(v []string)`

SetArchitectures sets Architectures field to given value.

### HasArchitectures

`func (o *ApiPublishedRepoUpdateSwitchParams) HasArchitectures() bool`

HasArchitectures returns a boolean if a field has been set.

### GetDescription

`func (o *ApiPublishedRepoUpdateSwitchParams) GetDescription() string`

GetDescription returns the Description field if non-nil, zero value otherwise.

### GetDescriptionOk

`func (o *ApiPublishedRepoUpdateSwitchParams) GetDescriptionOk() (*string, bool)`
...
`func (o *ApiPublishedRepoUpdateSwitchParams) SetDescription(v string)`

SetDescription sets Description field to given value.

### HasDescription

`func (o *ApiPublishedRepoUpdateSwitchParams) HasDescription() bool`
