...
// APIClient manages communication with the Aptly API API v1.6.2+20260228114657.9defe70
...
type APIClient struct {
	...
	MirrorsAPI *MirrorsAPIService

	PackagesAPI *PackagesAPIService

	PublishAPI *PublishAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.MirrorsAPI = (*MirrorsAPIService)(&c.common)
