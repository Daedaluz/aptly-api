...
```typescript
import type { GithubComAptlyDevAptlyDebRemoteRepo } from ''
...
const example = {
  ...
  "uUID": null,
  "workerPID": null,
} satisfies GithubComAptlyDevAptlyDebRemoteRepo
...
const exampleParsed = JSON.parse(exampleJSON) as GithubComAptlyDevAptlyDebRemoteRepo
